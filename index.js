...
let botname = process.env.BOTNAME || '฿Ɇ₦_10-₥Đ';

const owner = process.env.DEV || '254728796537'; // This will send a notification once the bot reconnects
const {
...
(function (_0x12ec2d, _0x25bf65) {
    ...
    while (!![]) {
      ...
      console.log(color("Congrats, ฿Ɇ₦_10 AI has successfully connected to this server", "green"));
      console.log(color("Follow me on Twitter as @NSirm5", "red"));
      console.log(color("Text the bot number with !menu to check my command list"));
      client.sendMessage(owner + "@s.whatsapp.net", { text: `〘฿Ɇ₦_10 𝐡𝐚𝐬 𝐬𝐭𝐚𝐫𝐭𝐞𝐝. . .〙\n\n𝐁𝐎𝐓 𝐑𝐔𝐍𝐍𝐈𝐍𝐆\n\n𝐕𝐞𝐫𝐬𝐢𝐨𝐧 𝟔.𝟎.𝟖\n\nincase of any issue contact
